...
[
  {
    ...
    "points": 25
      ...
      for (const line of lines) {
        // Detect new question starting with number like 1. or Soal 1:
      ...
      if (parsedQuestions.length === 0) {
        // Create a structured question from raw text block if regex couldn't separate numbers
...
[
  {
    ...
    "points": 25
      ...
      // Fallback generator if no key or error occurs
