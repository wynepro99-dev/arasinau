                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      ...
                      {isNotYetOpen && (
                        <span className="px-2 py-0.5 text-[10px] font-bold rounded uppercase bg-amber-50/80 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 border border-amber-100 dark:border-amber-900/40 flex items-center space-x-1 shrink-0">
                  ...
                  <div className="shrink-0 sm:w-36">
                    <button
                      ...
                      disabled={examQCount === 0 || isClosed || isNotYetOpen || !!prevAttempt}
